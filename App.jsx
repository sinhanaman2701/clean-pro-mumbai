    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-gray-800">Clean Pro Mumbai</span>
            </div>
      ...
      <section className="bg-gradient-to-br from-blue-600 to-blue-800 text-white py-20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Best House Cleaning Services in Andheri, Mumbai</h1>
          <p className="text-xl md:text-2xl mb-8 opacity-90">Professional House Cleaning Services services in Andheri, Mumbai. Trusted by hundreds of customers.</p>
      ...
      <section id="about" className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="text-gray-600 text-lg text-center max-w-3xl mx-auto">Welcome to Clean Pro Mumbai, your trusted House Cleaning Services provider in Andheri, Mumbai. We take pride in delivering exceptional service quality.</p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="max-w-xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-gray-600">Andheri, Mumbai</span>
            </div>
      ...
      <footer className="bg-gray-800 text-white py-8 text-center">
        <p>© 2026 Clean Pro Mumbai. All rights reserved.</p>
      </footer>
    </div>
  );
};
